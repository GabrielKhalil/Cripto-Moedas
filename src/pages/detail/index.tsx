  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.content}>
        ...
        <p>
          <strong>Maior preço 24 horas: </strong> {detail?.formatedHighprice}
        </p>
        <p>
          <strong>Menor preço 24 horas: </strong> {detail?.formatedLowprice}
        </p>
        <p>
          <strong>Delta 24 horas: </strong>
          <span className={Number(detail?.numberDelta && detail?.numberDelta) >= 0 ? styles.profit : styles.loss}>
            {detail?.delta_24h}
          </span>
        </p>
        <p>
